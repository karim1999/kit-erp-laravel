...
//            $associated_price_book= $account_instance->getRecord($account)->getData()->getFieldValue('Price_Book_Price_List');
//            dd($associated_price_book);
...
//        }
        foreach ($account_price_books as $account_price_book) {
            if($price)
                break;
            $account_price_book_id= $account_price_book->getFieldValue('Price_Book_Price_List')->getEntityId();
